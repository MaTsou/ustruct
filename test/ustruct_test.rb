...
describe Ustruct do
  describe 'Initialize' do
    ...
    it 'can receive both hash and named args' do
      foo = @foo.except(:baz) # reject { |k, v| k == :baz }
  ...
  describe 'Accessors' do
    ...
    it 'transforms given hash keys into methods' do
      @my_hash.each_key do |key|
        _(@context.__send__(key)).must_equal @my_hash[key]
      end
    end
    ...
    it 'duplicate values so initial hash mutation do not alter Ustruct' do
      @my_hash[:hello] = 1
      _(@context.hello).must_equal 'world'
    end
  end
end
